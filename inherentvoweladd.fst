...
%$inherentvoweladd$ = {#IPAconsonants##consonanttag#}: {#IPAconsonants##consonanttag#a<inherentvowel>} ^-> ( __ ![#viramatag##vowelsigntag#])
% ADD inherent vowel to a consonant if followed by another consonat or word end indicated by special characters or space
$inherentvoweladd$ = ({k}:{ka}|{kʰ}:{kʰa}|{ɡ}:{ɡa}|{ɡʱ}:{ɡʱa}|{ŋ}:{ŋa} |\
                      ...
                      {s}:{sa}|{ɦ}:{ɦa}|{ɭ}:{ɭa}|{ɽ}:{ɽa} |{r}:{ra}|{ṯṯa}:{ṯṯa‍}|{n‍ṯ}:{n‍ṯa}) ^-> (__[#consonanttag#][#IPAconsonants##spl-char##space#])
